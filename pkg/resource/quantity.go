...
var (
	...
	// ErrFormatWrong Errors that could happen while parsing a string.
	...
	// MaxMilliValue The maximum value we can represent milli-units for.
...
// Set the value of the internal Quantity. (used by flag & pflag)
